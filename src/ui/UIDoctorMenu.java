	...
	private static void showAddAvailableAppointmentsMenu() {
		...
		do {
			...
			if (response > 0 && response < 4) {
				...
				int monthSelected = response;	// variable para dar mayor legibilidad al código
				...
				// La sentencia continue provoca que únicamente la iteración actual del bucle más interno detenga su ejecución 
				// y que comience inmediatamente la siguiente iteración si el bucle todavía no ha terminado. 
